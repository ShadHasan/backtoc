...
.\binary\putty\PLINK.EXE %user%@%remotehost% -pw "%password%" -batch "cd %remotedir%/src ; gcc -I %remotedir%/src/main -Wall -Wextra -D CL_TARGET_OPENCL_VERSION=220 main/Main.c -o HelloOpenCL -lOpenCL;"
